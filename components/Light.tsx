...
const Light = () => {
    ...
    return (
        <div ref={parentRef} className=" h-full w-full  items-center justify-center ">
            <motion.div
             
             className="h-full w-full justify-center items-center relative"  
            >    
                            <motion.svg
                            animate ={{x:[parentWidth*0.1,parentWidth*0.48],y:[0,parentHeight*0.25],opacity:[1,0.1]}}
                            transition={{repeat:Infinity,duration:2,delay:Math.random()*2}}
                            initial={{ rotate: -45 }}
                               className="svg-icon absolute"
                               style={{ width: '5%', height: '5%', verticalAlign: 'middle', fill: 'currentColor', overflow: 'hidden' }}
                            ...
                            <motion.svg
                            animate ={{x:[parentWidth,parentWidth*0.48],y:[0,parentHeight*0.25],opacity:[1,0.1]}}
                            transition={{repeat:Infinity,duration:2,delay:Math.random()*2}}
                            initial={{ rotate: 50 }}
                               className="svg-icon absolute"
                               style={{ width: '5%', height: '5%', verticalAlign: 'middle', fill: 'currentColor', overflow: 'hidden' }}
                            ...
                            <motion.svg
                            animate ={{x:[parentWidth*0.48,parentWidth*0.48],y:[-parentWidth*0.1,parentHeight*0.25],opacity:[1,0.1]}}
                            transition={{repeat:Infinity,duration:2,delay:Math.random()*2}}
                            initial={{ rotate:0 }}
                               className="svg-icon absolute"
                               style={{ width: '5%', height: '5%', verticalAlign: 'middle', fill: 'currentColor', overflow: 'hidden' }}
                            ...
                            <motion.svg
                            animate ={{x:[parentWidth*0.1,parentWidth*0.45],y:[parentHeight*0.5,parentHeight*0.25],opacity:[1,0.1]}}
                            transition={{repeat:Infinity,duration:2,delay:Math.random()*2}}
                            initial={{ rotate:-120 }}
                               className="svg-icon absolute"
                               style={{ width: '5%', height: '5%', verticalAlign: 'middle', fill: 'currentColor', overflow: 'hidden' }}
                            ...
                            <motion.svg
                            animate ={{x:[parentWidth*0.9,parentWidth*0.45],y:[parentHeight*0.5,parentHeight*0.25],opacity:[1,0.1]}}
                            transition={{repeat:Infinity,duration:2,delay:Math.random()*2}}
                            initial={{ rotate:120 }}
                               className="svg-icon absolute"
                               style={{ width: '5%', height: '5%', verticalAlign: 'middle', fill: 'currentColor', overflow: 'hidden' }}
